...
import { STUTI_DANA, STUTI_RAZORPAY } from "./stuti-dana-core";
...
function DanaSheet({ lang = "deva", onClose }) {
  ...
  const rzpId = (STUTI_RAZORPAY || {})[pick];
            ...
            {step === "lit" ? (
              ...
              <React.Fragment>
                <div className="dana-soon">
                  <div className="dana-soon-mark"><Flame size={28} /></div>
  ...
  return (
    <React.Fragment>
      <button className={"dana-row" + (given ? " lit" : "")} onClick={() => setOpen(true)}>
        <span className="dana-row-mark">{given ? <Flame size={22} /> : <Icon name="lotus" size={20} />}</span>
...
export { useDana, DanaSheet, DanaRow };
