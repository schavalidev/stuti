...
function padaInScript(iast, lang, deva) {
  const d = deva || STUTI_PADA.toDeva(iast);
  if (lang === "telugu") return STUTI_TRANSLIT.convert(d, "telugu");
    ...
    <div className="pd-wrap">
      ...
      <div className="pd-sheet" role="dialog" aria-label={L.t("padartha", lang)}>
        ...
        <div className="pd-head">
          <button className="pd-nav" onClick={() => onStep(-1)} disabled={pada.wordIdx <= 0} aria-label={STUTI_L.a("aPrevWord")}>
          ...
          <button className="pd-nav" onClick={() => onStep(1)} disabled={pada.wordIdx >= pada.count - 1} aria-label={STUTI_L.a("aNextWord")}>
