...
const parFont = (lang) => STUTI_L.font(lang);
...
function ParayanaLens({ go, lang, onOpen }) {
  const L = STUTI_L, P = STUTI_PARAYANA;
...
function ParayanaDetail({ parayanaId, go, lang, onBack }) {
  const S = STUTI, L = STUTI_L, P = STUTI_PARAYANA;
      ...
      <div className="lens-pad">
        <header className="vr-hero">
          <div className="deity-hero-row">
            ...
            {VidhiJump && <VidhiJump hymnId={p.vidhiText} deity={p.deity} go={go} lang={lang} />}
          </div>
...
export { ParayanaLens, ParayanaDetail };
