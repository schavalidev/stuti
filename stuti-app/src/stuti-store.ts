...
/* ============================================================
   ...
   ============================================================ */
export const STUTI_FAVS = (function () {
...
/* ============================================================
   ...
   ============================================================ */
export const STUTI_FAVS_WEEK = (function () {
  ...
  const api = {
    ...
    add: (id, w) => {
      ...
      if (STUTI_FAVS) STUTI_FAVS._remove(id);
...
/* ============================================================
   ...
   ============================================================ */
export const STUTI_PROGRESS = (function () {
...
/* ============================================================
   ...
   ============================================================ */
export const STUTI_LOC = (function () {
  ...
  function detect(onDone) {
    ...
    navigator.geolocation.getCurrentPosition(
      async (pos) => {
        ...
        try { near = AKSHARA_PANCHANGA.nearest(lat, lon); } catch (e) {}
        if (near) {
...
/* ============================================================
   ...
   ============================================================ */
export const STUTI_ROUTE = (function () {
  const VIEW = {
