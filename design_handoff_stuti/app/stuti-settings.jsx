       ...
       <div className="set-page">
        ...
        <SetChapter icon="pray" title={L.t("setChReciter", uiLang)}>
          <SetPanel>
            ...
            <SetRow label={window.STUTI_AUTH.signedIn() ? (window.STUTI_AUTH.get().name || L.t("account", uiLang)) : L.t("accSignIn", uiLang)}
              sub={window.STUTI_AUTH.signedIn() ? L.t("accSyncWaiting", uiLang) : L.t("accLede", uiLang)}
