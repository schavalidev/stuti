    ...
    <span className="daypick">
      ...
      {open && <>
        ...
        <div className="daypick-pop" role="dialog" aria-label={label}>
          ...
          <div className="daypick-foot"><button type="button" onClick={() => pick(maxD)}>{window.STUTI_L.t("today", lang)}</button></div>
        </div>
      </>}
    </span>
  );
...
Object.assign(window, { ThreadCard, ThreadStrip, JapaEntryCard, JapaView, MalaEntry, JapaHistory, JAPA_THREADS });
