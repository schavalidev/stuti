/* ============================================================
   ...
   Attaches to window.STUTI_LIB.
   ============================================================ */
window.STUTI_LIB = (function () {
  ...
  const TYPE_ORDER = [
    ...
    "Sūkta", "Tarpaṇa", "Daṇḍaka", "Dhyāna-śloka", "Vandanā", "Stotra", "Kṛti", "Tālam", "Gītā", "Upaniṣad",
  ];
  const TYPE_LABELS = {
    ...
    "Tarpaṇa":      { deva: "तर्पण",           tel: "తర్పణం",            note: "Water offered to the forefathers" },
    ...
    "Tālam":        { deva: "ताळम्",           tel: "తాళం",              note: "Sung to a rhythmic cycle" },
  };
  function typeList() {
    const counts = {};
  ...
  /* Festivals & vrathams moved to stuti-vrata-data.js (window.STUTI_VRATA),
  ...
  const practices = [
    {
      ...
      steps: [
        ...
        { title: { roman: "Prāṇāyāma", deva: "प्राणायाम", tel: "ప్రాణాయామం" }, detail: { roman: "Steady the breath, reciting the praṇava, the vyāhṛtis, and the Gāyatrī once within.", deva: "प्रणव, व्याहृति और गायत्री सहित प्राणों का नियमन।", tel: "ప్రణవం, వ్యాహృతులు, గాయత్రితో ప్రాణ నియంత్రణ." } },
        { title: { roman: "Saṅkalpa", deva: "सङ्कल्प", tel: "సంకల్పం" }, detail: { roman: "State the time and the intent — to perform the sandhyā of this junction.", deva: "इस सन्ध्या-काल और संकल्प का उच्चारण।", tel: "ఈ సంధ్యా కాలం, సంకల్ప ఉచ్చారణ." } },
        ...
        { title: { roman: "Arghya-pradāna", deva: "अर्घ्य प्रदान", tel: "అర్ఘ్య ప్రదానం" }, detail: { roman: "The central act — offer water to the Sun three times, standing, facing the light. Given at or before sunrise in the morning, at or before sunset in the evening: it belongs to the joining, not to the day or the night.", deva: "मुख्य कर्म — सूर्य को तीन बार अर्घ्य, सूर्याभिमुख खड़े होकर। प्रातः सूर्योदय के पूर्व या उदयकाल में, सायं सूर्यास्त के पूर्व या अस्तकाल में — यह सन्धि का कर्म है।", tel: "ముఖ్య కర్మ — సూర్యునికి మూడుసార్లు అర్ఘ్యం, సూర్యాభిముఖంగా నిలిచి. ప్రాతఃకాలం సూర్యోదయానికి ముందు లేదా ఉదయ సమయంలో, సాయంకాలం సూర్యాస్తమయానికి ముందు లేదా అస్తమయ సమయంలో — ఇది సంధి కర్మ." } },
        { title: { roman: "Gāyatrī āvāhana", deva: "गायत्री आवाहन", tel: "గాయత్రీ ఆవాహన" }, detail: { roman: "Invoke and meditate on Gāyatrī, mother of the Vedas, seated in the heart.", deva: "वेदमाता गायत्री का आवाहन और ध्यान।", tel: "వేదమాత గాయత్రి ఆవాహన, ధ్యానం." } },
        ...
        { title: { roman: "Sūrya upasthāna", deva: "सूर्य उपस्थान", tel: "సూర్య ఉపస్థానం" }, detail: { roman: "Stand in praise of the Sun with the Āditya hymn before concluding — after sunrise in the morning, after sunset in the evening, the sun already risen or already set.", deva: "समापन से पूर्व आदित्य स्तुति में उपस्थान — प्रातः सूर्योदय के बाद, सायं सूर्यास्त के बाद।", tel: "ముగింపుకు ముందు ఆదిత్య స్తుతిలో ఉపస్థానం — ప్రాతఃకాలం సూర్యోదయం తరువాత, సాయంకాలం సూర్యాస్తమయం తరువాత." }, recite: { deity: "surya", m: "aditya hrdayam" } },
        { title: { roman: "Abhivādana", deva: "अभिवादन", tel: "అభివాదనం" }, detail: { roman: "Announce your lineage (gotra · pravara), salute the elders and the deities, and conclude with ācamana.", deva: "गोत्र-प्रवर सहित अभिवादन, नमस्कार और आचमन से समापन।", tel: "గోత్ర-ప్రవరతో అభివాదనం, నమస్కారం, ఆచమనంతో ముగింపు." } },
      ],
      note: { roman: "A short outline of the core sequence. The full vidhi varies by Veda-śākhā and family — learn it from your ācārya.", deva: "यह मूल क्रम का संक्षिप्त रूप है। पूर्ण विधि शाखा और परम्परा अनुसार भिन्न होती है — आचार्य से सीखें।", tel: "ఇది ప్రధాన క్రమపు సంక్షిప్త రూపం. పూర్తి విధి శాఖ, సంప్రదాయాన్ని బట్టి మారుతుంది — ఆచార్యుని వద్ద నేర్చుకోండి." },
    },
    {
      id: "nitya-puja", deity: "ganesha", seed: "गं",
      name: { roman: "Nitya Pūjā Vidhānam", deva: "नित्य पूजा विधानम्", tel: "నిత్య పూజా విధానం" },
      tagline: { roman: "The daily home worship — from cleansing and saṅkalpa through the sixteen upacāras to ārati.", deva: "नित्य गृह पूजा — शुद्धि और संकल्प से षोडशोपचार और आरती तक।", tel: "నిత్య గృహ పూజ — శుద్ధి, సంకల్పం నుండి షోడశోపచారం, హారతి వరకు." },
      when: { roman: "Each morning after bath, at the home altar", deva: "प्रतिदिन प्रातः स्नान के बाद, गृह देवस्थान में", tel: "ప్రతిరోజు ప్రాతః స్నానానంతరం, గృహ దేవస్థానంలో" },
      steps: [
        ...
        { title: { roman: "Ācamana · Prāṇāyāma", deva: "आचमन · प्राणायाम", tel: "ఆచమనం · ప్రాణాయామం" }, detail: { roman: "Sip water for purity and steady the breath before worship.", deva: "आचमन और प्राणायाम से शुद्धि।", tel: "ఆచమనం, ప్రాణాయామంతో శుద్ధి." } },
        { title: { roman: "Saṅkalpa", deva: "सङ्कल्प", tel: "సంకల్పం" }, detail: { roman: "State the day, the place, and the intent of today's pūjā.", deva: "तिथि, स्थान और आज की पूजा का संकल्प।", tel: "తిథి, స్థలం, నేటి పూజ సంకల్పం." } },
        ...
        { title: { roman: "Dhyāna & āvāhana", deva: "ध्यान · आवाहन", tel: "ధ్యానం · ఆవాహన" }, detail: { roman: "Contemplate the iṣṭa-devatā and invoke the presence upon the image.", deva: "इष्ट देव का ध्यान और आवाहन।", tel: "ఇష్ట దేవత ధ్యానం, ఆవాహన." } },
        ...
        { title: { roman: "Aṣṭottara / stotra", deva: "अष्टोत्तर · स्तोत्र", tel: "అష్టోత్తర · స్తోత్రం" }, detail: { roman: "Recite the deity's 108 names, or a stotra, offering a flower at each name.", deva: "देव के अष्टोत्तर शतनाम या स्तोत्र, प्रत्येक नाम पर पुष्प।", tel: "దేవత అష్టోత్తర శతనామాలు లేదా స్తోత్రం, ప్రతి నామానికి పుష్పం." } },
        { title: { roman: "Naivedya", deva: "नैवेद्य", tel: "నైవేద్యం" }, detail: { roman: "Offer food, sprinkling water around it; offer tāmbūla and a lamp.", deva: "जल-प्रोक्षण सहित नैवेद्य, ताम्बूल और दीप अर्पण।", tel: "జల ప్రోక్షణతో నైవేద్యం, తాంబూలం, దీపం సమర్పణ." } },
        { title: { roman: "Dhūpa-dīpa & ārati", deva: "धूप-दीप · आरती", tel: "ధూప-దీప · హారతి" }, detail: { roman: "Wave incense and the camphor flame; ring the bell and sing the ārati.", deva: "धूप और कर्पूर आरती, घण्टानाद सहित।", tel: "ధూపం, కర్పూర హారతి, గంటానాదంతో." } },
        { title: { roman: "Pradakṣiṇa · Namaskāra", deva: "प्रदक्षिणा · नमस्कार", tel: "ప్రదక్షిణ · నమస్కారం" }, detail: { roman: "Circumambulate and prostrate; ask pardon for any lapse, and share the prasāda.", deva: "प्रदक्षिणा, नमस्कार, क्षमापन और प्रसाद वितरण।", tel: "ప్రదక్షిణ, నమస్కారం, క్షమాపణ, ప్రసాద వితరణ." } },
      ],
      note: { roman: "A concise household order; the number and manner of upacāras vary by tradition. Adapt to your family's practice.", deva: "यह संक्षिप्त गृह-क्रम है; उपचारों की संख्या और रीति परम्परानुसार भिन्न होती है।", tel: "ఇది సంక్షిప్త గృహ క్రమం; ఉపచారాల సంఖ్య, రీతి సంప్రదాయాన్ని బట్టి మారుతుంది." },
    },
  ];
