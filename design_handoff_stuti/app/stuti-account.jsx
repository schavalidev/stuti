...
function AccountView({ go, lang = "deva", backView = "settings" }) {
  const L = window.STUTI_L, A = window.STUTI_AUTH, Icon = window.Icon;
  const session = useSession();
  const lamp = window.useDana();
...
Object.assign(window, { AccountView, useSession });
