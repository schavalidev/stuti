/* ============================================================
   ...
   ============================================================ */
window.AKSHARA_PANCHANGA = (function () {
  ...
  function sunRashi(date, flavour) {
    const EPH = window.STUTI_EPHEM;
    const fl = flavour || ((typeof window.ayanSys === "function") ? window.ayanSys() : "lahiri");
  ...
  function forDay(date, loc, opts) {
    ...
    if (window.STUTI_EPHEM && window.STUTI_EPHEM.setSystem) {
      window.STUTI_EPHEM.setSystem(typeof window.reckoning === "function" ? window.reckoning() : "drik");
    }
    ...
    const ayanFlavour = (typeof window.ayanSys === "function") ? window.ayanSys() : "lahiri";
    ...
    let grahana = null;
    if (window.STUTI_ECLIPSE && (tIndex === 13 || tIndex === 14 || tIndex === 15 || tIndex === 28 || tIndex === 29 || tIndex === 0)) {
      grahana = window.STUTI_ECLIPSE.forDay(date, loc, TZ);
      if (grahana) {
  ...
  function sankrantis(year) {
    const EPH = window.STUTI_EPHEM;
    if (!EPH) return [];
    if (EPH.setSystem) EPH.setSystem(typeof window.reckoning === "function" ? window.reckoning() : "drik");
    const fl = (typeof window.ayanSys === "function") ? window.ayanSys() : "lahiri";
