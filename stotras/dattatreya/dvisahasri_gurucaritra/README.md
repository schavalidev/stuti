...
**The three pieces outside the adhyāyas stand on a different footing, and their files say so.** The four-pass OCR that served the chapters does not cover the front and back matter usably, so for the Śrīgurustuti, the Yogarahasya and the Bodharahasya the page image is the sole witness. Sixteen readings could not be made out at 190 dpi. All sixteen were then settled at 400 to 1200 dpi with `bin/gurucaritra/zoom.py`: eleven were corrected and five confirmed as already right, and what decided each one is recorded at the verse. Nothing in this folder now rests on a guess.

**The commonest fault was a misplaced repha.** र् before a consonant is drawn as a hook ABOVE the cluster that follows it, so दार्ढ्य looks like दाढ्य with a mark on top and gets written down as दाढ्यार्. Three of the eleven were of that kind. The second commonest was the प्त ligature read as शि, भि or ग्न — settled by finding a known प्त elsewhere on the same page and comparing the glyphs. Both are worth knowing before reading any page of this print.

**One thing is recorded as unexplained rather than smoothed over.** In Yogarahasya 12 a small hook stands above the ā-stroke of द्ध्या, and the same hook appears after सिद्ध्या in verse 23 and after मा in verse 35. It is not this font's ordinary ā. The stroke is read as ā because nothing else fits the commentary or the sense, but the hook itself is not accounted for.
