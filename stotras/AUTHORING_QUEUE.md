...
- **Śītalā Saptamī** (C, re-searched 17 Sep on the user's push-back). **A printed vidhāna does exist, but not in Telugu.** The Telugu-base rule does not hold here; the choice of base is the user's. Nothing authored.
  - [ ] **Decide base, then author.** Candidates:
  ...
  - **The date disagrees with the design.** The design has Śrāvaṇa **śukla** saptamī; no print found puts it there. Vratarāja: `अथ शुक्लादिश्रावणकृष्णसप्तम्यां शीतलाव्रतम्‌` — Śrāvaṇa **kṛṣṇa** saptamī by pūrṇimānta reckoning. Nirṇayasindhu (`xqwn_nirnaya-sindhu-…-1901-nirnaya-sagara-press`, text layer yes, p. 98, index `शीतलाव्रतविधिः`): `भाद्रकृष्णसप्तम्यां शीतलाव्रतम्‌ । तत्र पूर्वा ग्राह्येति हेमाद्रौ` — Bhādrapada kṛṣṇa saptamī, on Hemādri's authority; a nirṇaya only, no vidhi. Gujarat keeps Śrāvaṇa vad sātam; North India keeps Śītalāṣṭamī / Basoḍā in Caitra kṛṣṇa. **To put to the user before authoring.**
  - **Śītalāṣṭakam**: not on disk (`grep -ril shitala stotras/` finds only the nāma `ఇందుశీతలాయై` in Lakṣmī nāmāvaḷis and `शीतल` in upacāra ślokas). The design asks for it to be read. Web witnesses: stotranidhi `sri-seethalashtakam` and vignanam `sri-sheetala-devi-ashtakam-sheetalashtakam` in all scripts; manuscripts `zsxw_75-sheetala-ashtakam-skanda-purana-kashi-maharani-collection-varanasi` (Skanda Purāṇa, image only) and `PadamaPuranaShitalaStotram1140Gha…` (Padma Purāṇa, image only). A separate authoring item from the vidhāna.
