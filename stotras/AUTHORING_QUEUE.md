...
- **Vaṭa Sāvitrī** (C, re-searched 17 Sep on the user's push-back). A printed vidhāna does exist, but **not in Telugu**; the Telugu-base rule may not hold here, and the choice of base is the user's.
  - [x] **Written 18 Sep 2026 as `puja/vrata/07_vata_savitri_vrata_kalpam.txt`, 58 units**, from the *Vratarāja* base the user chose, read off the page images of pp. 765–779 rather than the OCR. Both observances — the Southern full moon and the Western new moon — are recorded in the first unit as the base text records them, and the app's calendar data was not touched. No Vedic mantra anywhere in the rite, so no Paurāṇika twin. Witnesses read: the Marathi Kulkarṇī booklet (same Sanatkumāra frame and the same kathā verses; full moon only; name-form services to the pair as one) and the Hindi Mānav Vikās booklet (a different kathā recension set at Prabhāsa, and Vedic svastivācana that the base text has not). Hemādri himself was not reached, and that gap is stated in the file's header. Candidates as they stood:
...
- **Śītalā Saptamī** (C, re-searched 17 Sep, authored 18 Sep). **A printed vidhāna does exist, but not in Telugu.** The Telugu-base rule does not hold here, and the user chose the base.
  - [x] **Base decided and authored: `puja/vrata/13_shitala_saptami_vrata_kalpam.txt`, 22 units, not Vedic.** The *Vratarāja* is the base; the rite is the Skanda Purāṇa's and the kathā the Bhaviṣya Purāṇa's forty verses. The book's own Hindi bhāṣā ṭīkā is complete and much cleaner than its Sanskrit OCR, and was used throughout as the book's control on itself: twenty-six OCR letter-confusions were set right only where the ṭīkā names the same thing in the same place, and three places that neither the scan nor the ṭīkā can settle are left marked `[?]`. The print's own ब-for-व and ए-for-ऐ spellings are modernised once and recorded once rather than as forty repairs. The sentence of services names twenty-two acts, not sixteen, and is listed one to a line. Candidates as searched:
    - *Vratarāja* of Viśvanātha, Khemraj ed. with Mādhavācārya's Hindi bhāṣā ṭīkā — `vrataraj-of-vishvanath-sharma-with-bhasha-tika-by-madhavacharya-khemraj`, **pp. 308–313**, heading `शीतलासप्तमी` (djvu.txt lines ~15353–15561). **Text layer yes** (same 8.6 MB djvu.txt as the Vaṭa Sāvitrī entry; fair OCR). The one complete rite found anywhere. Tithi-nirṇaya (madhyāhna-vyāpinī, citing Hārīta through the Mādhavīya); vidhi from the **Skanda Purāṇa** — the dhyāna `वन्देऽहं शीतलां देवीं रासभस्थां दिगम्बराम्‌ । मार्जनीकलशोपेतां शूर्पालंकृतमस्तकाम्‌`, the naivedya verse `शीतले पञ्चपक्वान्नदध्योदनयुतं शुभम्‌`, the prārthanā `शीतले दह मे पापं`, the viśeṣa-arghya `शीतले शीतलाकारे`; saṅkalpa for अवैधव्य and progeny; kalaśa on an eight-petalled pīṭha with a golden Śītalā above it; a full nāma-mantra ṣoḍaśopacāra on `ॐ शीतलायै नमः`; feeding seven gaurīs; vāyana of curd-rice to a brāhmaṇa (`दध्यन्नं दक्षिणायुक्तं…शीतलाप्रीत्यै`). Then the kathā, 40 verses, `भविष्ये — कृष्ण उवाच` (Śubhakārī of Hastināpura), closing `इति श्रीभविष्यपुराणे शीतलाव्रतं सम्पूर्णम्‌`. **Vedic: no** — every upacāra is a nāma-mantra or a Paurāṇika śloka, so no Paurāṇika twin would be needed.
    - *Bṛhat Tāntrokta Śītalā Pūjā Paddhati*, Svāmī Prakāśānanda Tīrthanātha, Nadia 2014 — `qivx_brihat-tantrokta-shitala-puja-paddhati-…`. Bengali script, Bengali and Sanskrit; text layer yes (681 KB djvu.txt), but the OCR is Bengali script and the rite is **Tāntric and Bengali**, not a householder Smārta vrata. Witness only.
    - Gujarati, for the same day under its Gujarati name Śītalā Sātam: *Śītalā Sātamnā Māhātmya* (`in.ernet.dli.2015.419018`, 1901) and *Śītalā Sātamnī Kathā* (`dli.ernet.419692`). Text layer yes but the OCR of the old Gujarati type is poor. Both are **māhātmya and kathā, not vidhāna**.
  - **The date disagrees with the design.** The design has Śrāvaṇa **śukla** saptamī; no print found puts it there. Vratarāja: `अथ शुक्लादिश्रावणकृष्णसप्तम्यां शीतलाव्रतम्‌` — Śrāvaṇa **kṛṣṇa** saptamī by pūrṇimānta reckoning. Nirṇayasindhu (`xqwn_nirnaya-sindhu-by-shri-kamalakara-bhatta-mumbai-1901-nirnaya-sagara-press`, text layer yes; **the line is on printed p. 99, in the Janmāṣṭamī chapter — the book's index entry `शीतलाव्रतविधिः` gives p. 95 and is wrong**): `भाद्रकृष्णसप्तम्यां शीतलाव्रतम्‌ । तत्र पूर्वा ग्राह्येति हेमाद्रौ` — Bhādrapada kṛṣṇa saptamī, on Hemādri's authority; a nirṇaya only, no vidhi. Gujarat keeps Śrāvaṇa vad sātam; North India keeps Śītalāṣṭamī / Basoḍā in Caitra kṛṣṇa. **Put to the user, and settled 18 Sep: nothing is decided in the file.** All four dates — the Vratarāja's Śrāvaṇa kṛṣṇa, the Nirṇayasindhu's Bhādrapada kṛṣṇa, Gujarat's Śrāvaṇa vad sātam and the North's Caitra kṛṣṇa Śītalāṣṭamī — are set down neutrally in the header and in unit 2, alongside the note that the app's calendar shows Śrāvaṇa śukla saptamī, which no print read here supports. **The app's calendar data was not touched.**
  - [x] **Śītalāṣṭakam authored: `devi/main/45_shitala_ashtakam.txt`, 15 verses, not Vedic.** The name says eight and the text has fifteen; nothing was cut to make the two agree. The two web witnesses were both fetched and compared by machine and are **identical character for character over all thirty-three lines**, which is recorded as a fact about the two sites rather than as proof of the reading — they are very likely one lineage printed twice — so the file is written with a reduced cross-check and says so. No printed edition was reached and both manuscripts are page images with no text layer, so that gap stands. The vrata file and this one cross-reference each other and were not corrected from each other; they differ in one letter of the shared dhyāna verse, `शूर्पालंकृत` against `शूर्पालङ्कृत`, and each keeps what its own source prints. Original entry, kept for its search record: not on disk (`grep -ril shitala stotras/` finds only the nāma `ఇందుశీతలాయై` in Lakṣmī nāmāvaḷis and `शीतल` in upacāra ślokas). The design asks for it to be read. Web witnesses: stotranidhi `sri-seethalashtakam` and vignanam `sri-sheetala-devi-ashtakam-sheetalashtakam` in all scripts; manuscripts `zsxw_75-sheetala-ashtakam-skanda-purana-kashi-maharani-collection-varanasi` (Skanda Purāṇa, image only) and `PadamaPuranaShitalaStotram1140Gha…` (Padma Purāṇa, image only). A separate authoring item from the vidhāna.
  - Searched and empty: Āru Vratālu 1999 (`nkoi-aru-vratalu-…`, djvu.txt downloaded, two `శీతల` hits, both the Lakṣmī nāma and a pānīya upacāra); Vratha Ratnākaramu; dli Telugu scans; Mohan Publications; Gītā Press; stotranidhi's and vignanam's Telugu vrata and pūjā indexes (aṣṭakam only, no vidhi). No Telugu, Kannada or Tamil print carries a Śītalā vidhāna. Manuscripts only, image, witnesses at best: `0787_20250817` (`भविष्य शीतला व्रत`), `0386_20250816` (`शीतला व्रत`), `4599_20250818` (`शीतला व्रत स्तोत्र`), all Asha Archives Nepal; `ggmf_shitala-stotram-…` and `ztpx_shitala-stotram-…` (Jagannath Bhattarai collection). Not reached: Hemādri *Caturvarga Cintāmaṇi* Vratakhaṇḍa vol. 2 part 2 (`chaturvargachintamanihemadri…vol2part2vrata…`), which Nirṇayasindhu cites; TTD ebooks.
...
- [x] **Rakṣā Bandhan · Śrāvaṇī vrata written 18 Sep 2026** → `puja/vrata/08_raksha_bandhana_vrata_kalpam.txt`, 13 units. **The earlier verdict on this line was wrong and is corrected here.** It said thread-tying is a custom and not a pūjā. The Vratarāja prints the whole rite as the **Rakṣābandhana-paurṇamāsī-vrata of the Bhaviṣyottara Purāṇa**, quoted through Hemādri, in twenty-seven verses with a colophon — the Indrāṇī kathā, the order of the day, the making of the rakṣā, the tying, the mantra and the bhadrā prohibition. Base: the **Vratarāja** of Viśvanātha, Khemraj ed., **printed pp. 803–804** (scan leaves n825–n826). The text layer of that volume is fair, but **every verse was read off the page images**, and the images set right about a dozen OCR damages. The damaged pāda of verse 26 is settled: the print reads `ब्राह्मणैः क्षत्रियै-` / `वैश्यैः` across a line break, and that is transcribed as printed, not repaired. Witnesses read: the **Nirṇayasindhu** (six differences of reading, including `तेन त्वामपि बध्नामि` in the mantra against the base's `तेन त्वामभिबध्नामि`, and `कर्तव्यो रक्षिताचारो … शक्तितः` against `कर्तव्यो रक्षिकाबन्धो … भक्तितः`), and the **Dharmasindhu**, which prints the same mantra and supplies the rule of time the purāṇic passage lacks. Both sets of rules of time are in unit 13's `vidhi:` field, without the book names, which stay in the header. **Hemādri's Vratakhaṇḍa carries the mantra in a different setting with phala verses the base has not, but its Calcutta OCR is unusable and its page images were not read — that gap is stated in the file's header.** **Vedic: no** — every line is a Paurāṇika śloka or āryā, so **no Paurāṇika twin was made and none is needed**. **The upākarma is named as a step of the day and its text is not given**, on the user's decision not to add it; it is a Vedic karma of its own, śākhā by śākhā, and is not in this corpus. Open [?]: none.
- [x] **Ugādi · saṁvatsarārambha written 18 Sep 2026** → `puja/vrata/14_ugadi_samvatsarambha_vidhi.txt`, 21 units. **The earlier verdict on this line was wrong and is corrected here.** It said the day has pacchaḍi and pañcāṅga śravaṇam and no pūjā in any print, and that the day's worship is the nitya pūjā. That is not so. The **Vratarāja** of Viśvanātha, Khemraj ed., prints a complete rite for the day under its own heading `अथ चैत्रशुक्लप्रतिपदि सवत्सरारम्भविधिः`, **printed pp. 64–66** in the book's general part (scan leaves n87–n89), taken whole from the **Brahma Purāṇa**: the udayikī pratipad rule, the mahāśānti, the pūjā of Brahmā and then of the gods in order, and the long `नमो ब्रह्मणे तुभ्यम्` prayer that salutes the divisions of time one after another. Every Devanāgarī line was read off the page images; the book's own Hindi bhāṣā ṭīkā on pp. 67–69 was read in full as its control on its own Sanskrit. Witnesses: the **Nirṇayasindhu**, whose `वत्सरारम्भः` opens its second paricchheda (the leaf after printed p. 61), read off the page image — it carries the same Brahma Purāṇa and Vṛddhavasiṣṭha verses and adds two the base has not, the Jyotirnibandha verse on the lord of the year and the **Viṣṇudharma verse enjoining the worship of Brahmā** on this day, which is a second lineage for the day's pūjā; and the **Dharmasindhu**, which supplies the sentence naming the other acts of the day. **Hemādri was not reached**, and both books quote it. **A Telugu witness: the rite is not in any Telugu vrata compendium** — Vratha Ratnākaramu 1 and 2, Āru Vratālu 1999, Strīla Vrata Kathalu and the stotranidhi and vignanam Telugu indexes were all searched and are empty (Vrata Cūḍāmaṇi 1928 is inconclusive, its OCR unusable). What Telugu print does carry is **the same two nibandhas in Telugu script**, with one reading worth keeping: the Telugu Nirṇayasindhu has `నోపవాసస్తు` where the Devanāgarī has `सोपवासस्तु`, the Brahmā pūjā without a fast against with one. So a Telugu print exists but it is the same text, not a second rite, and the base stays the Vratarāja. **Vedic: no** — every mantra is a Paurāṇika verse and the pūjā is done by the name-mantra made from the prayer, so **no Paurāṇika twin was made and none is needed**. The homa of unit 19 is offered by a `वेदवित्` but its mantras are named in the text as the same prayer verses with `स्वाहा` at the end; not one Vedic mantra is quoted. **Nothing was emended**: five defective readings of the print are recorded in the header and left standing in the text. **The two circulating verses of the day stay out of the file** — the nīm verse `शतायुर्वज्रदेहाय` and the pañcāṅga-phala verse, neither of which is in any printed nibandha. Unit 21 names the oil bath, the flag, the eating of the nīm leaf and the hearing of the pañcāṅga as the Dharmasindhu names them, and prints no verse for them; both circulating verses stay recorded as unverified at `VRATA_DAY_OBSERVANCES.md`. Open [?]: none.
